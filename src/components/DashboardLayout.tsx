...
const DashboardLayout = () => {
  ...
  const isFullPortfolioDashboard = selectedLineId === null && location.pathname === "/dashboard";

  return (
    <div className="flex h-screen overflow-hidden bg-[#F8FAFC] dark:bg-[#0B0F19] text-foreground print:h-auto print:overflow-visible">
      {!isFullPortfolioDashboard && <div className="print:hidden flex shrink-0"><AppSidebar /></div>}

      <div className="flex-1 flex flex-col min-w-0 overflow-hidden print:overflow-visible">
        {/* Premium Top Bar */}
        {!isFullPortfolioDashboard && (
          <header className="hidden lg:flex h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-6 items-center justify-between z-30 shrink-0 print:hidden">
        ...
        <main className={cn(
          "flex-1 p-4 overflow-x-hidden overflow-y-auto bg-slate-50/30 dark:bg-slate-950/20 print:overflow-visible print:h-auto",
          isFullPortfolioDashboard 
            ? "pt-4 lg:p-8 pb-8" 
            : "pt-20 lg:p-8 pb-32 lg:pb-16"
        )}>
          <AnimatePresence>
            <motion.div
        ...
        {!isFullPortfolioDashboard && (
          <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[100] safe-area-bottom print:hidden">
                    ...
                    <div className="p-8 space-y-4 pb-12">
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        >
                          ...
                          <div className="text-left">
                            <p className="text-xs font-black uppercase tracking-tight text-slate-850">Manage Agents</p>
